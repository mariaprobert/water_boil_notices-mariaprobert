...
**WATER BOIL NOTICES**: Water boil notices tend to be concentrated in areas with a high population density. For example, counties near the greater Houston area experience more water boil notices than counties in the Panhandle. Population also plays a big role when it comes to the average, minimum and maximum length of water boil notices. We notice a concentration of longer lasting average and minimum lengths in areas with less population density. Large urban areas have more water boil notices, yet they are more quickly resolved. 
**TYPE OF NOTICES**: Notices are equally localized and systemwide. The more common issues relating to water boil notices in the state of Texas are due to system malfunctions such as distribution pressure or outages. There is no clear indication that 
**ONGOING NOTICES AND AFFECTED POPULATION**: 
