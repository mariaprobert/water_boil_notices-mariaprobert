...
I want to look at the counties with the longest lasting notice lengths, so I want to look at an average to determine the county with the longest lasting notices, then keep the minimum and maximum amount of days that water boil notices last in that county. 
