...
Our end date was having issues parsing, so we made sure that the date did not exist or was "NA," after we filtered it out we can see that maybe these dates are on going and thats why they were formatted differently from "start_date."
